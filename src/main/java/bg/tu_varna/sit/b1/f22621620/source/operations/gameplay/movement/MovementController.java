...
import bg.tu_varna.sit.b1.f22621620.source.exceptions.gameplay.IncorrectDirectionException;
import bg.tu_varna.sit.b1.f22621620.source.exceptions.gameplay.LeavingTheFieldException;
...
public class MovementController {
    ...
    public void move(String direction) {
        switch (direction) {
            case "up" -> {
                if (currentX == 0) {
                    throw new LeavingTheFieldException("Cannot leave the playing field!");
                }
                dx--;
            }
            case "down" -> {
            ...
            default -> throw new IncorrectDirectionException("Incorrect direction!");
        }
